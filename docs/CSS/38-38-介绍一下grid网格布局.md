...
![](/images/s_poetries_work_uploads_2022_09_7a6bebde16cd0dc1.webp)
...
![](/images/s_poetries_work_uploads_2022_09_f3265f7748c5cab6.webp)
...
```
  ...
  * `grid-auto-flow` 属性 
    ...
    * 顺序就是由`grid-auto-flow`决定，默认为行，代表"先行后列"，即先填满第一行，再开始放入第二行 ![](/images/s_poetries_work_uploads_2022_09_d973d2d25b7a9641.webp)
    * 当修改成`column`后，放置变为如下 ![](/images/s_poetries_work_uploads_2022_09_59cb05f9412d447a.webp)
...
```
    ...
    * `start` \- 对齐容器的起始边框
    * `end` \- 对齐容器的结束边框
    * `center` \- 容器内部居中 ![](/images/s_poetries_work_uploads_2022_09_aa3e504f73f0a7dc.webp)
    * `space-around` \- 每个项目两侧的间隔相等。所以，项目之间的间隔比项目与容器边框的间隔大一倍
    * `space-between` \- 项目与项目的间隔相等，项目与容器边框之间没有间隔
    * `space-evenly` \- 项目与项目的间隔相等，项目与容器边框之间也是同样长度的间隔
    * `stretch` \- 项目大小没有指定时，拉伸占据整个网格容器 ![](/images/s_poetries_work_uploads_2022_09_36511ef68d7b786b.webp)
...
```
    ...
    * 通过设置`grid-column`属性，指定`1`号项目的左边框是第二根垂直网格线，右边框是第四根垂直网格线 ![](/images/s_poetries_work_uploads_2022_09_8fdf4b8f5e6babf4.webp)
  * `grid-area` 属性 
...
![](/images/s_poetries_work_uploads_2022_09_6e019fdb0f08a21f.webp)
