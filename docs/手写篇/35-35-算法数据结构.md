...
![](/images/s_poetries_work_uploads_2022_07_849d5550c7f9720d.webp)

看图理解next层级

![](/images/s_poetries_work_uploads_2022_07_c634936bf1ffee06.webp)
```js
    // 链表 从头尾删除、增加 性能比较好
    // 分为很多类 常用单向链表、双向链表
...
![](/images/s_poetries_work_uploads_2022_07_fc61065b2fb36d9c.webp)
![](/images/s_poetries_work_uploads_2022_07_d28e693ef5b13fdf.webp)
```js
    // 测试
...
![](/images/s_poetries_work_uploads_2022_07_f7dc6b831874a1f2.webp)

二叉树的遍历方式

![](/images/s_poetries_work_uploads_2022_07_8a8d74db8db0e9bb.webp)
```js
    // 测试
    var bst = new BST((a,b)=>a.age-b.age) // 模拟sort方法
