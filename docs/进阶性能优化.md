...
![](/images/s_poetries_work_gitee_2020_07_performance_1.png)
...
![](/images/s_poetries_work_gitee_2020_07_performance_2.png)
...
![](/images/s_poetries_work_gitee_2020_09_109.png)

而具体到**图片** 这一类的资源，平均请求体积是这样的：

![](/images/s_poetries_work_gitee_2020_09_110.png)
...
![](/images/s_poetries_work_gitee_2020_07_performance_4.png)

京东首页也不例外：

![](/images/s_poetries_work_gitee_2020_07_performance_5.png)
...
![](/images/s_poetries_work_gitee_2020_07_performance_6.png)

较小的 Logo：

![](/images/s_poetries_work_gitee_2020_07_performance_7.png)

颜色简单、对比度较强的透明小图也在 PNG 格式下有着良好的表现：

![](/images/s_poetries_work_gitee_2020_07_performance_8.png)
...
![](/images/s_poetries_work_gitee_2020_07_performance_9.png)
...
![](/images/s_poetries_work_gitee_2020_07_performance_10.png)
...
![](/images/s_poetries_work_gitee_2020_07_performance_11.png)
...
![](/images/s_poetries_work_gitee_2020_07_performance_12.png)
...
![](/images/s_poetries_work_gitee_2020_07_performance_13.png)
...
> 补充(现代做法)：原文写于 2018 年，彼时 WebP 兼容性堪忧。如今 WebP 已被所有主流浏览器（含 Safari 14+）支持，可放心作为默认格式。更优雅的降级写法是用 `<picture>` 标签按格式优先级声明，浏览器会自动挑选第一个支持的源：
>
> ```html
> <picture>
...
> ```
>
> 同时关注更新的 **AVIF**（压缩率优于 WebP）。现代图片优化还包括：`<img loading="lazy">` 原生懒加载、`srcset`/`sizes` 响应式图片、`width`/`height` 占位避免布局抖动（CLS）。
...
![](/images/s_poetries_work_gitee_2020_07_performance_14.png)

我们给 `size` 这一栏一个特写：

![](/images/s_poetries_work_gitee_2020_07_performance_15.png)
...
![浏览器缓存：强缓存先行（Expires / Cache-Control，命中返回 200 不与服务端通信），未命中再走协商缓存（Last-Modified / ETag，未变返回 304）](/images/diagrams/http-cache.webp)
...
![](/images/s_poetries_work_gitee_2020_07_performance_16.png)
...
![](/images/s_poetries_work_gitee_2020_07_performance_17.png)
...
![](/images/s_poetries_work_gitee_2020_07_performance_18.png)
...
![](/images/s_poetries_work_gitee_2020_07_performance_19.png)
...
![](/images/s_poetries_work_gitee_2020_07_performance_20.png)
...
**PS** ：大家注意 `Service Worker` 对协议是有要求的，必须以 `https` 协议为前提。
...
![](/images/s_poetries_work_gitee_2020_07_performance_30.png)
...
![](/images/s_poetries_work_gitee_2020_07_performance_31.png)
...
![](/images/s_poetries_work_gitee_2020_07_performance_32.png)
...
![](/images/s_poetries_work_gitee_2020_07_performance_33.png)
...
![](/images/s_poetries_work_gitee_2020_07_performance_34.png)
...
![](/images/s_poetries_work_gitee_2020_07_performance_35.png)
