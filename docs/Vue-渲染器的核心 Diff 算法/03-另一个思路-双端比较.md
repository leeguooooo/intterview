...
![](/images/s_poetries_work_uploads_2024_02_242541513654fb21.webp)

在这个例子中，我们可以通过肉眼观察从而得知最优的解决方案应该是：**把`li-c` 节点对应的真实 DOM
移动到最前面即可**，只需要一次移动即可完成更新。然而，`React` 所采用的 `Diff` 算法在更新如上案例的时候，会进行两次移动：

![](/images/s_poetries_work_uploads_2024_02_9d3f42cbb025eedf.webp)
...
![](/images/s_poetries_work_uploads_2024_02_5d6d3836641bc1a6.webp)
...
![](/images/s_poetries_work_uploads_2024_02_a76e19b385e0bb88.webp)
...
![](/images/s_poetries_work_uploads_2024_02_777fbf4df88821ac.webp)

由于 `li-d` 节点所对应的真实 DOM 元素已经更新完成且被移动，所以现在真实 DOM
的顺序是：`li-d`、`li-a`、`li-b`、`li-c`，如下图所示：

![](/images/s_poetries_work_uploads_2024_02_0d30dad1934f9ce7.webp)
...
![](/images/s_poetries_work_uploads_2024_02_533db5e57c1ed0c9.webp)
...
![](/images/s_poetries_work_uploads_2024_02_5350d50f9328eedc.webp)
...
![](/images/s_poetries_work_uploads_2024_02_9285a505a83eb719.webp)
...
![](/images/s_poetries_work_uploads_2024_02_0ba7c12f50e26c0d.webp)
...
![](/images/s_poetries_work_uploads_2024_02_dbf60539b42d2d68.webp)
...
![](/images/s_poetries_work_uploads_2024_02_4756ae61c44e317b.webp)
...
![](/images/s_poetries_work_uploads_2024_02_eec6b6621fdbe3fe.webp)
...
![](/images/s_poetries_work_uploads_2024_02_72b22a35eb649f11.webp)
...
![](/images/s_poetries_work_uploads_2024_02_cf4b71dc23f86079.webp)
...
![](/images/s_poetries_work_uploads_2024_02_bb19b23fd5e2f01e.webp)
...
![](/images/s_poetries_work_uploads_2024_02_27d49216f446a731.webp)

接着，开始下一轮的比较，重新从第一步开始。结果和上一轮相似，同样在第二步中找到可复用的节点，所以在在这一轮的更新完成之后，其状态如下图所示：

![](/images/s_poetries_work_uploads_2024_02_575d12760b7a214f.webp)
...
![](/images/s_poetries_work_uploads_2024_02_df0e288269753200.webp)
...
![](/images/s_poetries_work_uploads_2024_02_2ed47ccfa8f1d761.webp)
...
![](/images/s_poetries_work_uploads_2024_02_84170a714397cccf.webp)
...
![](/images/s_poetries_work_uploads_2024_02_951e167b611e2bbd.webp)
