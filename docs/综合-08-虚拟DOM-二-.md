...
![img](/images/s_poetries_work_gitee_2019_10_606.webp)
...
![img](/images/s_poetries_work_gitee_2019_10_607.webp)
...
![img](/images/s_poetries_work_gitee_2019_10_609.webp)

>
> 在中间插入一个节点，程序员写代码很简单：$(B).after(F)。但如何高效地插入呢？简单粗暴的做法是：卸载C，装载F，卸载D，装载C，卸载E，装载D，装载E。如下图

![img](/images/s_poetries_work_gitee_2019_10_610.webp)
...
![img](/images/s_poetries_work_gitee_2019_10_611.webp)

> 如果我们在`JSX`里为数组或枚举型元素增加上`key`后，`React`就能根据`key`，直接找到具体的位置进行操作，效率比较高。如下图

![img](/images/s_poetries_work_gitee_2019_10_612.webp)
