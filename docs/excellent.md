...
![](/images/excellent/s_poetries_work_uploads_2022_09_07acd0b2a466762f.png)
...
![](/images/excellent/s_poetries_work_gitee_2020_07_fe_9.png)
...
![](/images/excellent/s_poetries_work_gitee_2020_07_fe_10.png)
...
![](/images/excellent/s_poetries_work_uploads_2023_01_88a40168a4f0a9f5.png)
...
![](/images/excellent/s_poetries_work_uploads_2023_01_0b35b75ee050d7c4.png)
...
![](/images/excellent/s_poetries_work_uploads_2022_08_b0f21ec685ae839b.png)
...
![](/images/excellent/s_poetries_work_uploads_2023_01_d62faae3969d2dde.png)
```html
...
![](/images/excellent/s_poetries_work_uploads_2023_01_6bb5ac2cdd9759ca.png)
...
![](/images/excellent/s_poetries_work_images_20210414212916.png)
![](/images/excellent/s_poetries_work_uploads_2023_01_c49d6ea59a1482e4.png)
```html
...
![](/images/excellent/s_poetries_work_images_20210314221335.png)
...
**1\. vdom**
  ...
  * **用JS模拟DOM结构**  
![](/images/excellent/s_poetries_work_uploads_2023_02_34c8532904ffd12f.png)
...
![](/images/excellent/s_poetries_work_uploads_2023_02_9e81506ea3345aea.png)
![](/images/excellent/s_poetries_work_uploads_2023_02_f304938694b28862.png)

**diff过程细节**

  * 新旧节点都有`children`，执行`updateChildren` `diff`对比 ![](/images/excellent/s_poetries_work_uploads_2023_02_2a4ac0a956e99b22.png)
    * 开始和开始对比--头头
    * 结束和结束对比--尾尾
    * 开始和结束对比--头尾
    * 结束和开始对比--尾头
...
![](/images/excellent/s_poetries_work_uploads_2023_02_6f9943fe553bfa0a.png)
...
![](/images/excellent/s_poetries_work_uploads_2023_02_84a8702352c0d1a7.png)
```js
    // 执行 node index.js
...
```
  ...
  * **3\. 完成流程图** ![](/images/excellent/s_poetries_work_uploads_2023_02_94729fa5b9fcb082.png)
...
![](/images/excellent/s_poetries_work_uploads_2023_02_6c8606aaa99af5cb.png)
```js
    methods: {
        addItem() {
...
![](/images/excellent/s_poetries_work_uploads_2022_08_e6c7ede9c5ab6d49.png)
...
![](/images/excellent/s_poetries_work_gitee_2020_07_61.png)
```html
    <div id="app">{{name}}</div>
    <script>
        const vm = new Vue({
...
![](/images/excellent/s_poetries_work_uploads_2023_02_99525a723bd206bd.png)
...
![](/images/excellent/s_poetries_work_uploads_2023_02_36af2f141c7659aa.png)
```vue
...
![](/images/excellent/s_poetries_work_uploads_2023_02_2ed64c281a747078.png)

**合成事件图示**

![](/images/excellent/s_poetries_work_uploads_2023_02_bd7cd8acbb3cfd85.png)
...
![](/images/excellent/s_poetries_work_uploads_2023_02_1ede1982d9eb5a45.png)

  2. `batchUpdate`机制

![](/images/excellent/s_poetries_work_uploads_2023_02_7bb96642c305b9d6.png)
![](/images/excellent/s_poetries_work_uploads_2023_02_e0e5828f54c4d6a1.png)
```js
...
![](/images/excellent/s_poetries_work_uploads_2023_02_4b2c232c6b39d3ac.png)
![](/images/excellent/s_poetries_work_uploads_2023_02_5a0b0ab821739984.png)
![](/images/excellent/s_poetries_work_uploads_2023_02_ad98ab68ffa45716.png)
```js
    // setState现象演示
...
![](/images/excellent/s_poetries_work_uploads_2023_01_6632a7a051a60c4c.png)
...
**1.组件渲染过程**
  ...
  * 渲染过程 
    * `setState(newState)` => `newState`存入`pending`队列，判断是否处于`batchUpdate`状态，保存组件于`dirtyComponents`中（可能有子组件） ![](/images/excellent/s_poetries_work_uploads_2023_02_1ede1982d9eb5a45.png)
...
![](/images/excellent/s_poetries_work_uploads_2023_02_98d2444a4b7995d9.png)
...
![](/images/excellent/s_poetries_work_uploads_2023_02_49204f33f8e7a350.png)

**React diff 特点 - 仅向右移动**

> 比较子节点时，仅向右移动，不向左移动。

![](/images/excellent/s_poetries_work_uploads_2023_02_7e0177856595febb.png)

**Vue2 diff 特点 - 双端比较**

![](/images/excellent/s_poetries_work_uploads_2023_02_dc386faff0955e94.png)
...
![](/images/excellent/s_poetries_work_uploads_2023_02_05879e82f60fa7af.png)
...
![](/images/excellent/s_poetries_work_uploads_2023_02_a68a7962c0801e70.png)
```html
    <ul>
...
![](/images/excellent/s_poetries_work_uploads_2023_02_bd495d045b61d7bc.png)
...
![](/images/excellent/s_poetries_work_uploads_2023_02_ee5e71b37a63fb7b.png)
...
![](/images/excellent/s_poetries_work_images_20210319101659.png)
...
![](/images/excellent/s_poetries_work_uploads_2022_09_195112577f1777bf.png)
...
![](/images/excellent/s_poetries_work_uploads_2022_09_2b1da6bb8a3fd972.png)
...
> 先分析遇到哪些问题，在配合下面的方法优化，不要上来就回答，让人觉得背面试题
  ...
  * 优化`babel-loader`缓存 ![](/images/excellent/s_poetries_work_uploads_2023_02_a9f33d5b7fb0dfad.png)
...
```
  ...
  * `noParse` 避免重复打包（引入但不打包） ![](/images/excellent/s_poetries_work_uploads_2023_02_0a9cd08a1e89e2f1.png)
  * `happyPack`多线程打包 
    * JS单线程的，开启多进程打包
    * 提高构建速度(特别是多核`CPU`)
```js
...
```
  ...
  * 自动刷新（开发环境）使用`dev-server`即可 ![](/images/excellent/s_poetries_work_uploads_2023_02_d88cc6944c88ef16.png)
  * 热更新（开发环境） 
  ...
  * `webpack`使用`production`模式，`mode: 'production'`
    ...
    * 启动`Tree Shaking`
      ...
      * **ES6模块和Commonjs模块区别**
        ...
        * 只有`ES6 Module`才能静态分析，实现`Tree Shaking` ![](/images/excellent/s_poetries_work_uploads_2023_02_8c992a059adfd272.png)
  * `Scope Hoisting`：是`webpack3`引入的一个新特性，它会分析出模块之间的依赖关系，尽可能地把打散的模块合并到一个函数中去，减少代码间的引用，从而减少代码体积 
    * 减少代码体积
    * 创建函数作用域更少
    * 代码可读性更好 ![](/images/excellent/s_poetries_work_uploads_2023_02_4312a5cf7761b232.png)
...
### HTTP缓存
  ...
  * **http缓存策略** （强制缓存 + 协商缓存） 
    * **强制缓存**
      ...
      * **强制缓存的流程图** ![](/images/excellent/s_poetries_work_uploads_2023_02_cf357b148b63c080.png) ![](/images/excellent/s_poetries_work_uploads_2023_02_c64e9237d005100c.png)
    * **协商缓存**
      * 服务端缓存策略
      ...
      * **服务端怎么判断客户端资源一样？** 根据资源标识 
        ...
        * `Last-Modified` 服务端返回的资源的最后修改时间 
          * `If-Modified-Since` 客户端请求时，携带的资源的最后修改时间（即`Last-Modified`的值） ![](/images/excellent/s_poetries_work_uploads_2023_02_282933521c137ef6.png)
        * `Etag`服务端返回的资源的唯一标识（一个字符串，类似指纹） 
          * `If-None-Matche` 客户端请求时，携带的资源的唯一标识（即`Etag`的值） ![](/images/excellent/s_poetries_work_uploads_2023_02_5410537fc2ebf124.png)
        * **Headers示例** ![](/images/excellent/s_poetries_work_uploads_2023_02_704949dd8a110763.png)
        * **请求示例** 通过`Etag`或`Last-Modified`命中缓存，没有返回资源，返回`304`，体积非常小 ![](/images/excellent/s_poetries_work_uploads_2023_02_8aa4cc91818455d9.png)
    * **HTTP缓存总结** ![](/images/excellent/s_poetries_work_uploads_2023_02_e808802f780e55c9.png)
  * **刷新操作方式，对缓存的影响**
...
![](/images/excellent/s_poetries_work_uploads_2023_01_6772692df973c752.png)
...
![](/images/excellent/s_poetries_work_uploads_2023_01_4c1465795bc8f0c2.png)
![](/images/excellent/s_poetries_work_uploads_2023_01_0b9d0fa902d5bf1c.png)
...
![](/images/excellent/s_poetries_work_uploads_2023_01_8137dab52f536f6d.png)
...
![](/images/excellent/s_poetries_work_uploads_2023_01_bea409a27a4e9ad2.png)
```js
    // 登录：用户名 密码
...
![](/images/excellent/s_poetries_work_uploads_2023_01_428ac761b592fbc1.png)
...
![](/images/excellent/s_poetries_work_uploads_2023_01_dd8c1b843050ec62.png)
...
![](/images/excellent/s_poetries_work_gitee_2020_03_1.png)
![](/images/excellent/s_poetries_work_uploads_2023_01_d007d70173797c88.png)

**预防中间人攻击**

> 使用正规厂商的证书，慎用免费的

![](/images/excellent/s_poetries_work_uploads_2023_01_8cb095d80e81cb18.png)
...
![](/images/excellent/s_poetries_work_uploads_2023_01_fe5986f609f48612.png)
```js
    console.log('start')
    setTimeout(() => { 
      console.log('timeout')
...
![](/images/excellent/s_poetries_work_uploads_2023_01_4ad9b7d93fa9ad2b.png)
...
![](/images/excellent/s_poetries_work_uploads_2023_01_0e07c6f647f1a3c5.png)
...
![](/images/excellent/s_poetries_work_uploads_2023_01_030cb840c0edabe7.png)
...
![](/images/excellent/s_poetries_work_uploads_2023_02_7d1c0a6aff18214a.png)
  ...
  * **让加载更快**
    ...
    * 减少访问次数：合并代码，`SSR`服务端渲染，缓存 
      ...
      * **缓存**
        ...
        * `url`和文件不变，则会自动触发`http`缓存机制，返回`304` ![](/images/excellent/s_poetries_work_uploads_2023_02_3a284db5c7da6390.png)
    * 减少请求时间：`DNS`预解析，`CDN`，`HTTP2`
      ...
      * **CDN**
        ...
        * `CDN`的缺点：增加了网络延迟，增加了服务器成本 ![](/images/excellent/s_poetries_work_uploads_2023_02_e81a3bb1769d3e74.png)
      * **HTTP2**
        * `HTTP2`：`HTTP`协议的下一代版本
...
```
    ...
    * 懒加载（图片懒加载，上滑加载更多） ![](/images/excellent/s_poetries_work_uploads_2023_02_8f0de9086d90c75c.png)
    * 对`DOM`查询进行缓存 ![](/images/excellent/s_poetries_work_uploads_2023_02_93d7e1f458b5b1a1.png)
    * 频繁`DOM`操作，合并到一起插入到`DOM`结构 ![](/images/excellent/s_poetries_work_uploads_2023_02_5b7fc06e1aef4c9f.png)
    * 节流、防抖，让渲染更流畅 
      * **防抖**
        * 防抖动是将多次执行变为`最后一次执行`
        * 适用于：`input`、`click`等
  ...
  * **发布订阅模式**
    ...
    * **发布订阅者模式和观察者模式的区别？**
      ...
      * 总结一下： 
        ...
        * 发布订阅模式：`publisher`和`subscriber`互相不认识，需要有中间媒介`Event Channel`。如`EventBus`自定义事件 ![](/images/excellent/s_poetries_work_uploads_2023_01_15a98c64893feadc.png)
    * **实现的思路：**
      * 创建一个对象(缓存列表)
...
![](/images/excellent/s_poetries_work_uploads_2022_07_5eb6f5edb37a9abd.png)

**通过Chrome Performance分析**

> 打开浏览器无痕模式，点击`Performance > ScreenShot`

![](/images/excellent/s_poetries_work_uploads_2023_01_182f4ecc5a9438e1.png)

如果加载很快就会很快就到达`FP`，在分析`FCP、LCP、DCL、L`看渲染时间

![](/images/excellent/s_poetries_work_uploads_2023_01_01b6b3e2049c7f2b.png)

国内访问GitHub可以看到加载到`FP`非常慢，但是渲染很快

![](/images/excellent/s_poetries_work_uploads_2023_01_5b5e62734fa8f2cc.png)

`network > show overview` 查看每个资源的加载时间，或者从`waterfall`查看

![](/images/excellent/s_poetries_work_uploads_2023_01_225e509acef89fbf.png)

**使用lighthouse分析**

![](/images/excellent/s_poetries_work_uploads_2023_01_48150d9b04f2240f.png)
```bash
    # 通过node使用
    npm i lighthouse -g
...
![](/images/excellent/s_poetries_work_uploads_2023_01_2f1725384591607d.png)
...
![](/images/excellent/s_poetries_work_uploads_2023_01_0e45cf3988121684.png)
![](/images/excellent/s_poetries_work_uploads_2023_01_e68963dec49dbe97.png)
...
![](/images/excellent/s_poetries_work_uploads_2022_07_e47703fd75859ad8.png)
![](/images/excellent/s_poetries_work_uploads_2023_01_b6ce0bd8b072ae9c.png)
...
![](/images/excellent/s_poetries_work_uploads_2022_07_0abcf5e689d2716b.png)
![](/images/excellent/s_poetries_work_uploads_2023_01_07fded84cc81ece4.png)
...
![](/images/excellent/s_poetries_work_uploads_2023_02_5c6bd3977e62de20.png)
```js
...
![](/images/excellent/s_poetries_work_uploads_2023_02_2600c71b11497adf.png)
```js
    /**
...
![](/images/excellent/s_poetries_work_uploads_2023_01_b35e3101a79fe1b6.png)
...
### 设计实现一个H5图片懒加载
  ...
  * **分析**
    ...
    * 滚动要节流
  * **获取图片定位**
    * 元素的位置`ele.getBoundingClientRect` ![](/images/excellent/s_poetries_work_uploads_2023_02_bb6dc4fbd4180ec6.png)
...
![](/images/excellent/s_poetries_work_uploads_2023_01_6ce62d970d0719f4.png)
...
![](/images/excellent/s_poetries_work_uploads_2023_01_553d2314d0d81dfe.png)
...
![](/images/excellent/s_poetries_work_uploads_2023_01_29b41c380edea0e9.png)
```js
    /**
...
![](/images/excellent/s_poetries_work_uploads_2023_01_1ffdb03bf7e1a9e9.png)

  * 递归，代码逻辑更加清晰
  * 非递归，性能更好
  * 二分查找时间复杂度 `O(logn)` 非常快

![](/images/excellent/s_poetries_work_uploads_2023_01_cbcae41ac652112f.png)
...
![](/images/excellent/s_poetries_work_uploads_2023_01_1f0b3548cfbcff91.png)
```js
    /**
...
![](/images/excellent/s_poetries_work_uploads_2023_01_454a91cd6ac51c43.png)
