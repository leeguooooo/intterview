...
![](/images/s_poetries_work_images_20210328214931.webp)
...
![](/images/s_poetries_work_images_20210328215207.webp)
```js
    class Vue {
      constructor (options) {
        // 1. 保存选项的数据
...
![](/images/s_poetries_work_images_20210328215538.webp)
```js
    // 负责数据劫持
...
![](/images/s_poetries_work_images_20210328215943.webp)
...
![](/images/s_poetries_work_images_20210328220733.webp)
...
![](/images/s_poetries_work_images_20210328220757.webp)
```js
    class Dep {
      constructor () {
        // 存储所有的观察者
...
![](/images/s_poetries_work_images_20210328221004.webp)

  * 功能 
    * 当数据变化触发依赖， `dep` 通知所有的 `Watcher` 实例更新视图
    * 自身实例化的时候往 `dep` 对象中添加自己 -结构

![](/images/s_poetries_work_images_20210328221037.webp)
```js
    class Watcher {
...
![](/images/s_poetries_work_images_20210328221437.webp)
