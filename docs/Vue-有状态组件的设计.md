...
从这个模板来看 `MyComponent` 组件至少涉及到两个 `VNode`，第一个 `VNode` 是标签 `<MyComponent />`
...
![](/images/s_poetries_work_uploads_2024_02_f27d595b932c886a.webp)
...
![](/images/s_poetries_work_uploads_2024_02_022e6a497c274c59.webp)
