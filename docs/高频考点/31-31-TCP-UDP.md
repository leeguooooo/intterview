...
![](/images/s_poetries_work_gitee_2020_07_fe_34.webp)
...
![](/images/s_poetries_work_gitee_2020_07_fe_35.webp)
...
![](/images/s_poetries_work_gitee_2020_07_fe_36.webp)

  * 发送端窗口是由接收窗口剩余大小决定的。接收方会把当前接收窗口的剩余大小写入应答报文，发送端收到应答后根据该值和当前网络拥塞情况设置发送窗口的大小，所以发送窗口的大小是不断变化的。
  * 当发送端接收到应答报文后，会随之将窗口进行滑动

![](/images/s_poetries_work_gitee_2020_07_fe_37.webp)
