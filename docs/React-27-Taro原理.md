...
![](/images/s_poetries_work_gitee_2020_09_92.webp)
...
![](/images/s_poetries_work_gitee_2020_09_239.webp)
...
![](/images/s_poetries_work_gitee_2020_09_240.webp)
...
![](/images/s_poetries_work_gitee_2020_09_241.webp)
![](/images/s_poetries_work_gitee_2020_09_242.webp)
...
![](/images/s_poetries_work_gitee_2020_09_244.webp)
![](/images/s_poetries_work_gitee_2020_09_245.webp)
...
![](/images/s_poetries_work_gitee_2020_09_245.webp)
![](/images/s_poetries_work_gitee_2020_09_246.webp)
...
> `taro-cli` 包位于 `Taro` 工程的 `Packages` 目录下，通过 `npm install -g @tarojs/cli`
...
> `Taro` 项目主要是由一系列 `NPM` 包组成，位于工程的 `Packages` 目录下。它的包管理方式和 `Babel`
...
![](/images/s_poetries_work_gitee_2020_09_247.webp)
...
![](/images/s_poetries_work_gitee_2020_09_248.webp)
...
![](/images/s_poetries_work_gitee_2020_09_250.webp)

> 你也可以使用 [ASTExploroer (opens new window)](https://astexplorer.net/) 快速地查看代码的
> `AST`
...
![](/images/s_poetries_work_gitee_2020_09_251.webp)
...
首先我们可以先看 `<View className='home'>`，它在 `AST`中是一个 `JSXElement，它的结构和我们定义`Element
...
![](/images/s_poetries_work_gitee_2020_09_252.webp)

> 小程序页面的`componentWillMount` 有一点特殊，会有两种初始化方式。由于小程序的页面需要等到 `onLoad`
...
![](/images/s_poetries_work_gitee_2020_09_253.webp)
...
> Taro 对小程序的所有 API 进行了一个分类整理，将其中的异步 API 做了一层
...
![](/images/s_poetries_work_gitee_2020_09_254.webp)
...
![](/images/s_poetries_work_gitee_2020_09_255.webp)
...
![](/images/s_poetries_work_gitee_2020_09_256.webp)

注意看这几个文件：`core-js/modules/web.dom.iterable`，`core-
...
![](/images/s_poetries_work_gitee_2020_09_257.webp)
...
![](/images/s_poetries_work_gitee_2020_09_258.webp)
