...
![](/images/s_poetries_work_images_20210414175500.webp)
...
![](/images/s_poetries_work_images_20210414210720.webp)
...
![](/images/s_poetries_work_images_20210408100806.webp)
...
![](/images/s_poetries_work_images_20210414210917.webp)

### 18 事件循环

![事件循环：执行同步代码 → 清空所有微任务 → 取一个宏任务执行，如此循环往复](/images/diagrams/event-loop.webp)

![](/images/s_poetries_work_images_20210516161332.webp)
...
![](/images/s_poetries_work_images_20210516162034.webp)
![](/images/s_poetries_work_images_20210516162330.webp)

> 自动执行的情况 会输出 listener1 listener2 task1 task2

![](/images/s_poetries_work_images_20210516162704.webp)
![](/images/s_poetries_work_images_20210516163038.webp)

> 如果手动点击click 会一个宏任务取出来一个个执行，先执行click的宏任务，取出微任务去执行。会输出 listener1 task1
> listener2 task2

![](/images/s_poetries_work_images_20210516163647.webp)
```js
    console.log(1)
...
![](/images/s_poetries_work_gitee_2020_09_10.webp)
...
**微任务**
  ...
  * `Object.observe`
  * `MutationObserver`
    * ![](/images/s_poetries_work_images_20210516165328.webp)
...
![](/images/s_poetries_work_images_20210414211816.webp)
...
![](/images/s_poetries_work_images_20210414142630.webp)
...
![](/images/s_poetries_work_images_20210414134752.webp)
...
![](/images/s_poetries_work_images_20210414141731.webp)
...
![](/images/s_poetries_work_uploads_2022_08_f636f4c6e3cfbd36.webp)
...
![](/images/s_poetries_work_gitee_2020_09_9.webp)
