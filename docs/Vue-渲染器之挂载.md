...
![](/images/s_poetries_work_uploads_2024_02_1e74bad4264c445b.webp)
...
我们使用 `h` 函数创建了一个描述 `div` 标签的 `VNode` 对象，观察 `VNodeData` 可以发现，它拥有一些内联样式，所以在
...
![](/images/s_poetries_work_uploads_2024_02_b246f283925e3893.webp)
...
![](/images/s_poetries_work_uploads_2024_02_cdd5ce233259e7d2.webp)
...
![](/images/s_poetries_work_uploads_2024_02_c307e84482200af6.webp)
...
完整代码&在线体验地址：<https://codesandbox.io/s/397w7kxy1>[ (opens new
...
刚才我们讲解了为什么同样是写在标签上的属性，却要区分对待的原因，接下来我们进入正题，开始完成将属性应用到 DOM 元素上的实现，到目前为止，我们已经为
...
![](/images/s_poetries_work_uploads_2024_02_bf5c631339510653.webp)
...
当然从模板到 `VNodeData` 的这个变化是由编译器来做的，这样设计之后我们就可以很容易地区分 `VNodeData` 中的某个属性是 DOM
...
![](/images/s_poetries_work_uploads_2024_02_8a6c8bc46e52701b.webp)
...
![](/images/s_poetries_work_uploads_2024_02_10301451530c73bc.webp)
...
![](/images/s_poetries_work_uploads_2024_02_a5574e9cd8a098c5.webp)
...
![](/images/s_poetries_work_uploads_2024_02_a36595be236a4c42.webp)
...
![](/images/s_poetries_work_uploads_2024_02_f49b158a31644537.webp)
...
在挂载函数式组件的时候，比挂载有状态组件少了一个实例化的过程，如果一个 `VNode` 描述的是函数式组件，那么其 `tag`
属性值就是该函数的引用，如下：
...
![](/images/s_poetries_work_uploads_2024_02_c7eade36dfee3450.webp)
