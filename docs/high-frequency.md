...
![](/images/s_poetries_work_uploads_2022_09_55340636fa7cdcee.png)
...
![](/images/s_poetries_work_uploads_2023_01_88a40168a4f0a9f5.png)
...
![](/images/s_poetries_work_uploads_2023_01_d62faae3969d2dde.png)
```html
...
![](/images/s_poetries_work_uploads_2023_01_6bb5ac2cdd9759ca.png)
...
![](/images/s_poetries_work_uploads_2023_02_7d1c0a6aff18214a.png)
  ...
  * **让加载更快**
    ...
    * 减少请求时间：`DNS`预解析，`CDN`，`HTTP2`
      ...
      * **CDN**
        ...
        * `CDN`的缺点：增加了网络延迟，增加了服务器成本 ![](/images/s_poetries_work_uploads_2023_02_e81a3bb1769d3e74.png)
      * **HTTP2**
        * `HTTP2`：`HTTP`协议的下一代版本
  ...
  * **发布订阅模式**
    ...
    * **发布订阅者模式和观察者模式的区别？**
      ...
      * 总结一下： 
        ...
        * 发布订阅模式：`publisher`和`subscriber`互相不认识，需要有中间媒介`Event Channel`。如`EventBus`自定义事件 ![](/images/s_poetries_work_uploads_2023_01_15a98c64893feadc.png)
    * **实现的思路：**
      * 创建一个对象(缓存列表)
...
![](/images/s_poetries_work_uploads_2022_07_5eb6f5edb37a9abd.png)

**通过Chrome Performance分析**

> 打开浏览器无痕模式，点击`Performance > ScreenShot`

![](/images/s_poetries_work_uploads_2023_01_182f4ecc5a9438e1.png)

如果加载很快就会很快就到达`FP`，在分析`FCP、LCP、DCL、L`看渲染时间

![](/images/s_poetries_work_uploads_2023_01_01b6b3e2049c7f2b.png)

国内访问GitHub可以看到加载到`FP`非常慢，但是渲染很快

![](/images/s_poetries_work_uploads_2023_01_5b5e62734fa8f2cc.png)

`network > show overview` 查看每个资源的加载时间，或者从`waterfall`查看

![](/images/s_poetries_work_uploads_2023_01_225e509acef89fbf.png)

**使用lighthouse分析**

![](/images/s_poetries_work_uploads_2023_01_48150d9b04f2240f.png)
```bash
    # 通过node使用
    npm i lighthouse -g
...
![](/images/s_poetries_work_uploads_2023_01_2f1725384591607d.png)
...
![](/images/s_poetries_work_uploads_2023_01_b35e3101a79fe1b6.png)
...
### 设计实现一个H5图片懒加载
  ...
  * **分析**
    ...
    * 滚动要节流
  * **获取图片定位**
    * 元素的位置`ele.getBoundingClientRect` ![](/images/s_poetries_work_uploads_2023_02_bb6dc4fbd4180ec6.png)
...
![](/images/s_poetries_work_uploads_2023_01_6ce62d970d0719f4.png)
...
![](/images/s_poetries_work_uploads_2023_01_553d2314d0d81dfe.png)
...
![](/images/s_poetries_work_uploads_2023_01_1ffdb03bf7e1a9e9.png)

  * 递归，代码逻辑更加清晰
  * 非递归，性能更好
  * 二分查找时间复杂度 `O(logn)` 非常快

![](/images/s_poetries_work_uploads_2023_01_cbcae41ac652112f.png)
