import{_ as n,c as s,o as e,a}from"./app-BuhGo8SK.js";const t="/images/s_poetries_work_uploads_2024_02_f27d595b932c886a.webp",o="/images/s_poetries_work_uploads_2024_02_022e6a497c274c59.webp",p={},c=a(`<h2 id="简版速记" tabindex="-1"><a class="header-anchor" href="#简版速记"><span>简版速记</span></a></h2><ul><li><strong>插槽存储位置</strong>：子节点放在 <code>VNode.slots</code>（而非 <code>children</code>），在组件实例化之后、<code>render</code> 执行之前注入到 <code>instance.$slots</code>，使 render 函数可访问插槽内容。</li><li><strong>普通插槽 vs 作用域插槽</strong>：本质相同，区别仅在于 <code>$slots.default</code> 是否为接受参数的函数。Vue 2.6+ 已统一：所有插槽均为返回 VNode 的函数，普通插槽是作用域插槽的无参子集。</li><li><strong>key</strong>：VNode 唯一标识，供 diff 算法复用节点。</li><li><strong>ref</strong>：设计为回调函数；挂载普通元素时传入真实 DOM，挂载组件时传入组件实例。</li><li><strong>parentVNode</strong>：描述组件标签的 VNode（即使用侧的 <code>&lt;MyComponent /&gt;</code>）；组件实例通过 <code>$parentVNode</code> 引用它，<code>$emit</code> 从中读取事件监听器。</li><li><strong>contextVNode</strong>：子组件标签描述 VNode 上存储的父组件标签 VNode，用于建立 <code>$parent</code> / <code>$children</code> / <code>$root</code> 父子链；函数式组件无实例，沿链向上跳过。</li><li><strong>VNode.el</strong>：挂载后存储对应真实 DOM 的引用；组件 el 指向其产出 VNode 的根元素，Fragment el 指向第一个子元素，Portal/空 Fragment el 指向占位空文本节点。</li></ul><p>假设我们有如下模板：</p><div class="language-html line-numbers-mode" data-highlighter="prismjs" data-ext="html" data-title="html"><pre class="language-html"><code><span class="line">    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>MyComponent</span><span class="token punctuation">&gt;</span></span></span>
...
<span class="line">      <span class="token literal-property property">el</span><span class="token operator">:</span> 占位的空文本元素 <span class="token comment">// document.createTextNode(&#39;&#39;)</span></span>
<span class="line">    <span class="token punctuation">}</span></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>阅读全文</p>`,99),l=[c];function i(d,r){return e(),s("div",null,l)}const m=n(p,[["render",i],["__file","Vue-有状态组件的设计.html.vue"]]),v=JSON.parse('{"path":"/Vue-%E6%9C%89%E7%8A%B6%E6%80%81%E7%BB%84%E4%BB%B6%E7%9A%84%E8%AE%BE%E8%AE%A1.html","title":"Vue 有状态组件的设计","lang":"zh-CN","frontmatter":{"title":"Vue 有状态组件的设计","description":"简版速记 插槽存储位置：子节点放在 VNode.slots（而非 children），在组件实例化之后、render 执行之前注入到 instance.$slots，使 render 函数可访问插槽内容。 普通插槽 vs 作用域插槽：本质相同，区别仅在于 $slots.default 是否为接受参数的函数。Vue 2.6+ 已统一：所有插槽均为返回 V...","head":[["meta",{"property":"og:url","content":"https://interview.leeguoo.com/Vue-%E6%9C%89%E7%8A%B6%E6%80%81%E7%BB%84%E4%BB%B6%E7%9A%84%E8%AE%BE%E8%AE%A1.html"}],["meta",{"property":"og:site_name","content":"前端面试题集锦"}],["meta",{"property":"og:title","content":"Vue 有状态组件的设计"}],["meta",{"property":"og:description","content":"简版速记 插槽存储位置：子节点放在 VNode.slots（而非 children），在组件实例化之后、render 执行之前注入到 instance.$slots，使 render 函数可访问插槽内容。 普通插槽 vs 作用域插槽：本质相同，区别仅在于 $slots.default 是否为接受参数的函数。Vue 2.6+ 已统一：所有插槽均为返回 V..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:image","content":"https://interview.leeguoo.com/images/s_poetries_work_uploads_2024_02_f27d595b932c886a.webp"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2026-07-06T04:15:51.000Z"}],["meta",{"property":"article:modified_time","content":"2026-07-06T04:15:51.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"Vue 有状态组件的设计\\",\\"image\\":[\\"https://interview.leeguoo.com/images/s_poetries_work_uploads_2024_02_f27d595b932c886a.webp\\",\\"https://interview.leeguoo.com/images/s_poetries_work_uploads_2024_02_022e6a497c274c59.webp\\"],\\"dateModified\\":\\"2026-07-06T04:15:51.000Z\\",\\"author\\":[]}"]]},"headers":[{"level":2,"title":"简版速记","slug":"简版速记","link":"#简版速记","children":[]},{"level":2,"title":"key 和 ref","slug":"key-和-ref","link":"#key-和-ref","children":[]},{"level":2,"title":"parentVNode 以及它的作用","slug":"parentvnode-以及它的作用","link":"#parentvnode-以及它的作用","children":[]},{"level":2,"title":"contextVNode","slug":"contextvnode","link":"#contextvnode","children":[]},{"level":2,"title":"el","slug":"el","link":"#el","children":[]}],"git":{"updatedTime":1783311351000,"contributors":[{"name":"leeguooooo","email":"guoli@zhihu.com","commits":4},{"name":"guoli","email":"guoli@zhihu.com","commits":2}]},"autoDesc":true,"filePathRelative":"Vue-有状态组件的设计.md","excerpt":"<h2>简版速记</h2>\\n<ul>\\n<li><strong>插槽存储位置</strong>：子节点放在 <code>VNode.slots</code>（而非 <code>children</code>），在组件实例化之后、<code>render</code> 执行之前注入到 <code>instance.$slots</code>，使 render 函数可访问插槽内容。</li>\\n<li><strong>普通插槽 vs 作用域插槽</strong>：本质相同，区别仅在于 <code>$slots.default</code> 是否为接受参数的函数。Vue 2.6+ 已统一：所有插槽均为返回 VNode 的函数，普通插槽是作用域插槽的无参子集。</li>\\n<li><strong>key</strong>：VNode 唯一标识，供 diff 算法复用节点。</li>\\n<li><strong>ref</strong>：设计为回调函数；挂载普通元素时传入真实 DOM，挂载组件时传入组件实例。</li>\\n<li><strong>parentVNode</strong>：描述组件标签的 VNode（即使用侧的 <code>&lt;MyComponent /&gt;</code>）；组件实例通过 <code>$parentVNode</code> 引用它，<code>$emit</code> 从中读取事件监听器。</li>\\n<li><strong>contextVNode</strong>：子组件标签描述 VNode 上存储的父组件标签 VNode，用于建立 <code>$parent</code> / <code>$children</code> / <code>$root</code> 父子链；函数式组件无实例，沿链向上跳过。</li>\\n<li><strong>VNode.el</strong>：挂载后存储对应真实 DOM 的引用；组件 el 指向其产出 VNode 的根元素，Fragment el 指向第一个子元素，Portal/空 Fragment el 指向占位空文本节点。</li>\\n</ul>"}');export{m as comp,v as data};
