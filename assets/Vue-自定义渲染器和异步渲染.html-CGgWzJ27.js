...
</code></pre><p>文本元素的 <code>type</code> 类型值为 <code>&#39;TEXT&#39;</code>，<code>parentNode</code> 同样被初始化为 <code>null</code>，<code>text</code> 属性存储着文本节点的内容。由于文本元素没有子节点、属性/特性、事件等信息，因此不需要其他描述信息。</p><p>文本节点与元素节点的创建都已经实现，接下来我们看看当元素被追加时应该如何处理，即 <code>nodeOps.appendChild</code> 函数的实现：</p><pre><code>const { render } = createRenderer({
  nodeOps: {
    createElement(tag) {
      const customElement = {/* 省略... */}
      return customElement
...
</code></pre><p>怎么样，是不是很简单。当然了这只是自定义渲染器的应用之一，对于自定义渲染器来说，它可发挥的空间还是非常大的，举几个例子：</p><ul><li>渲染到 <code>PDF</code>，我们可以实现一个自定义渲染器如 <code>vue-pdf-renderer</code>，它能够将 <code>Vue</code> 组件渲染为 <code>PDF</code> 文件。</li><li>渲染到文件系统，我们可以实现一个 <code>vue-file-renderer</code>，它可以根据 <code>VNode</code> 的结构在本地渲染与该结构相同的文件目录。</li><li><code>canvas</code> 渲染器，我们可以实现一个 <code>vue-canvas-renderer</code>，它可以从渲染器的层面渲染 <code>canvas</code>，而非组件层面。</li></ul><p>以上仅仅是简单的列了几个小想法，实际上由于自定义渲染器本身就是平台无关的，很多事情需要看特定平台的能力，渲染器为你提供的就是在组件层面的抽象能力以及虚拟 DOM 的更新算法，剩下的就靠社区的想象力和实现能力了。</p><p>TIP</p><p>完整代码&amp;在线体验地址：<a href="https://codesandbox.io/s/v39py7lxq5" target="_blank" rel="noopener noreferrer">https://codesandbox.io/s/v39py7lxq5</a><a href="https://codesandbox.io/s/v39py7lxq5" target="_blank" rel="noopener noreferrer"> (opens new window)</a></p><h2 id="references" tabindex="-1"><a class="header-anchor" href="#references"><span>References</span></a></h2><ul><li><a href="https://www.youtube.com/watch?reload=9&amp;v=cCOL7MC4Pl0&amp;feature=youtu.be" target="_blank" rel="noopener noreferrer">Jake Archibald: In The Loop - JSConf.Asia 2018 (opens new window)</a></li><li><a href="https://stackoverflow.com/questions/25915634/difference-between-microtask-and-macrotask-within-an-event-loop-context" target="_blank" rel="noopener noreferrer">https://stackoverflow.com/questions/25915634/difference-between-microtask-and-macrotask-within-an-event-loop-context</a><a href="https://stackoverflow.com/questions/25915634/difference-between-microtask-and-macrotask-within-an-event-loop-context" target="_blank" rel="noopener noreferrer"> (opens new window)</a></li><li><a href="https://html.spec.whatwg.org/#event-loop-processing-model" target="_blank" rel="noopener noreferrer">https://html.spec.whatwg.org/#event-loop-processing-model</a><a href="https://html.spec.whatwg.org/#event-loop-processing-model" target="_blank" rel="noopener noreferrer"> (opens new window)</a></li></ul><p>阅读全文</p>`,78),o=[p];function c(l,i){return a(),s("div",null,o)}const d=n(t,[["render",c],["__file","Vue-自定义渲染器和异步渲染.html.vue"]]),u=JSON.parse('{"path":"/Vue-%E8%87%AA%E5%AE%9A%E4%B9%89%E6%B8%B2%E6%9F%93%E5%99%A8%E5%92%8C%E5%BC%82%E6%AD%A5%E6%B8%B2%E6%9F%93.html","title":"Vue 自定义渲染器和异步渲染","lang":"zh-CN","frontmatter":{"title":"Vue 自定义渲染器和异步渲染","description":"简版速记 核心思路：将渲染器中所有平台相关的 DOM 操作抽象为可注入的接口，使渲染器与具体平台解耦。 createRenderer(options)：接收 nodeOps（元素增删查方法集）和 patchData（属性/事件更新函数）两类选项，返回平台无关的 render 函数。 nodeOps 必须实现的接口：createElement、creat...","head":[["meta",{"property":"og:url","content":"https://interview.leeguoo.com/Vue-%E8%87%AA%E5%AE%9A%E4%B9%89%E6%B8%B2%E6%9F%93%E5%99%A8%E5%92%8C%E5%BC%82%E6%AD%A5%E6%B8%B2%E6%9F%93.html"}],["meta",{"property":"og:site_name","content":"前端面试题集锦"}],["meta",{"property":"og:title","content":"Vue 自定义渲染器和异步渲染"}],["meta",{"property":"og:description","content":"简版速记 核心思路：将渲染器中所有平台相关的 DOM 操作抽象为可注入的接口，使渲染器与具体平台解耦。 createRenderer(options)：接收 nodeOps（元素增删查方法集）和 patchData（属性/事件更新函数）两类选项，返回平台无关的 render 函数。 nodeOps 必须实现的接口：createElement、creat..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2026-07-06T04:15:51.000Z"}],["meta",{"property":"article:modified_time","content":"2026-07-06T04:15:51.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"Vue 自定义渲染器和异步渲染\\",\\"image\\":[\\"\\"],\\"dateModified\\":\\"2026-07-06T04:15:51.000Z\\",\\"author\\":[]}"]]},"headers":[{"level":2,"title":"简版速记","slug":"简版速记","link":"#简版速记","children":[]},{"level":2,"title":"自定义渲染器的原理","slug":"自定义渲染器的原理","link":"#自定义渲染器的原理","children":[]},{"level":2,"title":"自定义渲染器的应用","slug":"自定义渲染器的应用","link":"#自定义渲染器的应用","children":[]},{"level":2,"title":"References","slug":"references","link":"#references","children":[]}],"git":{"updatedTime":1783311351000,"contributors":[{"name":"leeguooooo","email":"guoli@zhihu.com","commits":3},{"name":"guoli","email":"guoli@zhihu.com","commits":2}]},"autoDesc":true,"filePathRelative":"Vue-自定义渲染器和异步渲染.md","excerpt":"<h2>简版速记</h2>\\n<ul>\\n<li><strong>核心思路</strong>：将渲染器中所有平台相关的 DOM 操作抽象为可注入的接口，使渲染器与具体平台解耦。</li>\\n<li><strong><code>createRenderer(options)</code></strong>：接收 <code>nodeOps</code>（元素增删查方法集）和 <code>patchData</code>（属性/事件更新函数）两类选项，返回平台无关的 <code>render</code> 函数。</li>\\n<li><strong><code>nodeOps</code> 必须实现的接口</strong>：<code>createElement</code>、<code>createText</code>、<code>setText</code>、<code>appendChild</code>、<code>insertBefore</code>、<code>removeChild</code>、<code>parentNode</code>、<code>nextSibling</code>、<code>querySelector</code>。</li>\\n<li><strong><code>@vue/runtime-test</code></strong>：官方测试用自定义渲染器；用普通 JS 对象模拟 DOM 节点，可在 Node.js（无浏览器 DOM）中运行组件渲染断言。</li>\\n<li><strong>自定义元素结构最小集</strong>：<code>{ type, tag, parentNode, children, props, eventListeners, text }</code>。</li>\\n<li><strong>典型应用场景</strong>：单元测试（<code>@vue/runtime-test</code>）、Canvas 渲染器、PDF 渲染、文件系统渲染、跨端（uni-app / Weex）等。</li>\\n<li><strong>面试要点</strong>：自定义渲染器 ≠ 自定义组件；它工作在框架最底层，决定 VNode 如何被映射到任意宿主环境。</li>\\n</ul>"}');export{d as comp,u as data};
